// Nueva clase para la ventana de edición de reportes
...
public class ReportesEditarWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public ReportesEditarWindow() {
        // Configuración de la ventana
        setTitle("Editar Reportes");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Editar Tabla de Reportes", SwingConstants.CENTER);
