// Nueva clase para la ventana de consulta de reportes
...
public class ReportesConsultaWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public ReportesConsultaWindow() {
        // Configuración de la ventana
        setTitle("Consulta de Reportes");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Tabla de Reportes", SwingConstants.CENTER);
