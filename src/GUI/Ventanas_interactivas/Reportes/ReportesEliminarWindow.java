package GUI.Ventanas_interactivas.Reportes;
...
public class ReportesEliminarWindow extends JFrame {
    ...
    public ReportesEliminarWindow() {
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Eliminar Reportes", SwingConstants.CENTER);
        ...
        // Mostrar los datos de la tabla "Reportes"
        mostrarDatosTabla("Reportes");
    }
    ...
    private void saveAndClose() {
        ...
        try (Connection conn = DriverManager.getConnection(url)) {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement("DELETE FROM Reportes WHERE id = ?")) {
