package GUI.Ventanas_interactivas.Habitantes;
...
public class HabitantesEliminarWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;
    private HashSet<Integer> deletedRowsIds; // Almacena los IDs de los registros eliminados

    public HabitantesEliminarWindow() {
        // Configuración de la ventana
        setTitle("Eliminar Habitantes");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Eliminar Habitantes", SwingConstants.CENTER);
        ...
        // Mostrar los datos de la tabla "Habitantes"
        mostrarDatosTabla("Habitantes");
    }
    ...
    private void saveAndClose() {
        ...
        try (Connection conn = DriverManager.getConnection(url)) {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement("DELETE FROM Habitantes WHERE id = ?")) {
