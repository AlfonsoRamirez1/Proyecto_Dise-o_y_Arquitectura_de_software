...
public class HabitantesEditarWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public HabitantesEditarWindow() {
        // Configuración de la ventana
        setTitle("Editar Habitantes");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Editar Tabla de Habitantes", SwingConstants.CENTER);
    ...
    private void saveAndClose() {
        ...
        String query = "UPDATE Habitantes SET";
