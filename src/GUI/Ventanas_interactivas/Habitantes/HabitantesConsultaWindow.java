...
public class HabitantesConsultaWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public HabitantesConsultaWindow() {
        // Configuración de la ventana
        setTitle("Consulta de Habitantes");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Tabla de Habitantes", SwingConstants.CENTER);
