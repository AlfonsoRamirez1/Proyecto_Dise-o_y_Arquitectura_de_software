...
public class LocalidadesConsultaWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public LocalidadesConsultaWindow() {
        // Configuración de la ventana
        setTitle("Consulta de Localidades");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Tabla de Localidades", SwingConstants.CENTER);
