package GUI.Ventanas_interactivas.Localidad;
...
public class LocalidadesEliminarWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;
    private HashSet<Integer> deletedRowsIds; // Almacena los IDs de los registros eliminados

    public LocalidadesEliminarWindow() {
        // Configuración de la ventana
        setTitle("Eliminar Localidades");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Eliminar Localidades", SwingConstants.CENTER);
        ...
        // Mostrar los datos de la tabla "Localidades"
        mostrarDatosTabla("Localidades");
    }
    ...
    private void saveAndClose() {
        ...
        try (Connection conn = DriverManager.getConnection(url)) {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement("DELETE FROM Localidades WHERE id = ?")) {
