...
public class LocalidadesEditarWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public LocalidadesEditarWindow() {
        // Configuración de la ventana
        setTitle("Editar Localidades");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Editar Tabla de Localidades", SwingConstants.CENTER);
    ...
    private void saveAndClose() {
        ...
        try (Connection conn = DriverManager.getConnection(url)) {
            for (int row = 0; row < tableModel.getRowCount(); row++) {
                StringBuilder sb = new StringBuilder("UPDATE Localidades SET ");
