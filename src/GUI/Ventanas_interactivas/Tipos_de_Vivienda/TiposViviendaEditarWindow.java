...
public class TiposViviendaEditarWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public TiposViviendaEditarWindow() {
        // Configuración de la ventana
        setTitle("Editar Tipos de Vivienda");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Editar Tabla de Tipos de Vivienda", SwingConstants.CENTER);
    ...
    private void saveAndClose() {
        ...
        String query = "UPDATE TiposVivienda SET";
