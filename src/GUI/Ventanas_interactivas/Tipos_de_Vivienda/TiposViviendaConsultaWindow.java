...
public class TiposViviendaConsultaWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public TiposViviendaConsultaWindow() {
        // Configuración de la ventana
        setTitle("Consulta de Tipos de Vivienda");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Tabla de Tipos de Vivienda", SwingConstants.CENTER);
