...
public class MunicipiosEditarWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public MunicipiosEditarWindow() {
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Editar Tabla de Municipios", SwingConstants.CENTER);
