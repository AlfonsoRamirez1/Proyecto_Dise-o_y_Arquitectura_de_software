...
public class MunicipiosConsultaWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public MunicipiosConsultaWindow() {
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Tabla de Municipios", SwingConstants.CENTER);
