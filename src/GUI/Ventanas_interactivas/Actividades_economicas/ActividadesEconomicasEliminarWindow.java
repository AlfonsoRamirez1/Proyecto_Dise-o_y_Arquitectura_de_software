...
public class ActividadesEconomicasEliminarWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;
    private HashSet<Integer> deletedRowsIds; // Almacena los IDs de los registros eliminados

    public ActividadesEconomicasEliminarWindow() {
        // Configuración de la ventana
        setTitle("Eliminar Actividades Económicas");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Eliminar Actividades Económicas", SwingConstants.CENTER);
    ...
    private void saveAndClose() {
        ...
        try (Connection conn = DriverManager.getConnection(url)) {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement("DELETE FROM ActividadesEconomicas WHERE id = ?")) {
