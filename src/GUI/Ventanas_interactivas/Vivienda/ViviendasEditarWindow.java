...
public class ViviendasEditarWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public ViviendasEditarWindow() {
        // Configuración de la ventana
        setTitle("Editar Viviendas");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Editar Tabla de Viviendas", SwingConstants.CENTER);
    ...
    private void saveAndClose() {
        ...
        String query = "UPDATE Viviendas SET";
