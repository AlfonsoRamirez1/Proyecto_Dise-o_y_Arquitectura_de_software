package GUI.Ventanas_interactivas.Vivienda;
...
public class ViviendasEliminarWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;
    private HashSet<Integer> deletedRowsIds; // Almacena los IDs de los registros eliminados

    public ViviendasEliminarWindow() {
        // Configuración de la ventana
        setTitle("Eliminar Viviendas");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Eliminar Viviendas", SwingConstants.CENTER);
        ...
        // Mostrar los datos de la tabla "Viviendas"
        mostrarDatosTabla("Viviendas");
    }
    ...
    private void saveAndClose() {
        ...
        try (Connection conn = DriverManager.getConnection(url)) {
            ...
            try (PreparedStatement pstmt = conn.prepareStatement("DELETE FROM Viviendas WHERE id = ?")) {
