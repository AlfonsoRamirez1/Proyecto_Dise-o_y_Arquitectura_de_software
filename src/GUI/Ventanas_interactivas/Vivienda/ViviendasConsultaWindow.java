...
public class ViviendasConsultaWindow extends JFrame {
    private JTable dataTable;
    private DefaultTableModel tableModel;

    public ViviendasConsultaWindow() {
        // Configuración de la ventana
        setTitle("Consulta de Viviendas");
        setSize(600, 400);
        ...
        // Mensaje superior
        JLabel messageLabel = new JLabel("Tabla de Viviendas", SwingConstants.CENTER);
